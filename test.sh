#!/bin/bash
# ---
# RightScript Name: install ansible on ubuntu server
sudo apt-get install python-pip python-dev
sudo -H pip install ansible==2.9.6

==============================================================================================================
#!/bin/bash
# ---
# RightScript Name: install terraform on ubuntu server
curl -O https://raw.githubusercontent.com/sameeryalvigi/terraform-installer/master/terraform-install.sh
chmod +x terraform-install.sh
./terraform-install.sh -i 0.12.24
...
#!/bin/bash
# ---
# RightScript Name: install kubectl on ubuntu server
...
#!/bin/bash
# ---
# RightScript Name: install azure CLI on ubuntu server
sudo apt-get update
